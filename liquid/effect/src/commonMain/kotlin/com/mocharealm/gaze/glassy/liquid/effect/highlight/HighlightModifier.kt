package com.mocharealm.gaze.glassy.liquid.effect.highlight
...
import com.mocharealm.gaze.glassy.liquid.effect.RuntimeShaderCacheImpl
import com.mocharealm.gaze.glassy.liquid.effect.ShapeProvider
import com.mocharealm.gaze.glassy.liquid.effect.clipOutline
import com.mocharealm.gaze.glassy.core.platform.*
...
internal class HighlightNode(
    ...
    private fun DrawScope.configurePaint(highlight: Highlight) {
        ...
        paint.setBlurMaskFilter(
            if (blurRadius > 0f) {
                createBlurMaskFilter(blurRadius)
            } else {
                null
            }
        )
        if (PlatformVersion.supportsRenderEffect()) {
            ...
            paint.setPlatformShader(shader?.asPlatformShader())
        }
    }
}
