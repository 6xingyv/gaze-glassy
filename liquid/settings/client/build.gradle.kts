...
kotlin {
    androidLibrary {
        namespace = "com.mocharealm.gaze.glassy.liquid.settings.client"
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "GazeGlassyLiquidSettingsClient"
            isStatic = true
        }
    }
...
mavenPublishing {
    ...
    coordinates("com.mocharealm.gaze", "glassy-liquid-settings-client", libs.versions.gaze.glassy.get())

    pom {
        name = "Gaze Glassy Liquid Settings Client"
